...
class OrderTree {
    private BestGeneTracker bestGeneTracker;
    private LastGeneTracker lastGeneTracker;
    public Node root;
    ...
    public OrderTree(int N, int targetFitness) {
        this.bestGeneTracker = new BestGeneTracker(loadExistingSolutionsFromFile(filePath));
        //System.out.println("Loaded existing solutions from file: " + filePath);

        this.lastGeneTracker = new LastGeneTracker(loadExistingCheckedFromFile(filePath2));
